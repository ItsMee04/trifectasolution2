    ...
    <div class="top-nav-search">
        <div class="d-flex align-items-center" style="height: 60px; min-width: 350px; white-space: nowrap;">
            <div class="header-datetime text-primary fw-bold">
                ...
                <span id="current-date">Memuat data...</span>
    ...
    <ul class="nav user-menu">
        ...
        <li class="nav-item dropdown has-arrow new-user-menus">
            <a href="#" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
                <span class="user-img">
                    <img src="{{ asset('storage/pegawai/image/' . Session::get('image')) }}" alt="User Image"
                        class="avatar-img rounded-circle"
                        onerror="this.src='{{ asset('assets/img/profiles/avatar-01.jpg') }}'">
                    <div class="user-text">
...
<script>
    function updateDateTime() {
        ...
        // Format Tanggal (Contoh: Senin, 09 Januari 2026)
        const options = {
            weekday: 'long',
            year: 'numeric',
            month: 'long',
