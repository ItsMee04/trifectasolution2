 <div class="table-responsive">
     <table class="table border-0 star-student table-hover table-center mb-0 datatable table-striped" id="roleTable"
         style="width: 100%">
 ...
 <script>
     ...
     function getRoleService() {
         ...
         return {
             "url": "/role/getRole", // Menggunakan route name Laravel
             "type": "GET",
         ...
         if ($('#roleTable').length > 0) {
             $('#roleTable').DataTable({
                 ...
                 "columns": [{
                     ...
                     {
                         "data": "role"
                     }, // Pastikan di JSON Controller key-nya adalah "role"
                     {
                         "data": "status",
