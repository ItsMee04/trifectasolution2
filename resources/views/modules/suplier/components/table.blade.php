 <div class="table-responsive">
     <table class="table border-0 star-student table-hover table-center mb-0 datatable table-striped" id="suplierTable"
         style="width: 100%">
 ...
 <script>
     ...
     function getSuplierService() {
         // Kita mengembalikan objek AJAX agar bisa digunakan oleh DataTable
         return {
             "url": "/suplier/getSuplier", // Menggunakan route name Laravel
             "type": "GET",
